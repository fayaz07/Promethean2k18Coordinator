...
import co.promethean2k18.com.Data_.Student_Profile_model;
            ...
            public void onClick(View v) {
                if (isDataLoaded && internetCheck.isIsInternetAvailable()) {
                    ...
                    if (TextUtils.isEmpty(name.getText())
                            ...
                            || TextUtils.isEmpty(college.getText())
                            || TextUtils.isEmpty(roll.getText()) ){
                        Snackbar.make(layout,"You must fill all the details", Snackbar.LENGTH_SHORT).show();
                    }
                    profile_model.setName(name.getText().toString());
                    profile_model.setUid("Offline by " + StoreMyData.organizerProfile.getName());
                    profile_model.setDept(dept.getSelectedItem().toString());
                    profile_model.setYear(year.getSelectedItem().toString());
                    profile_model.setRoll(roll.getText().toString());
                    profile_model.setCollege(college.getText().toString());
                    profile_model.setEmail(email.getText().toString());
                    profile_model.setPhone(phone.getText().toString());
...
//        }
    ...
    private void register(String reg_token,String e_name, String e_id, String p_uid, String p_name,String p_phone,String p_email,String p_refer) {
        ...
        AndroidNetworking.post(Urls.eventregister)
                ...
                .addBodyParameter("p_uid","Offline by " + StoreMyData.organizerProfile.getName())
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.trim().equals("exists")) {
                            ...
                            Snackbar.make(layout, "Registered successfully, Thank You!", Toast.LENGTH_SHORT).show();
